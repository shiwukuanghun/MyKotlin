...
import com.wuchen.mykotlin.forest.*
import kotlinx.android.synthetic.main.activity_secret.*

/**
 * Time：2019/5/21 10:48
 * Author：WuChen
 * Description：
 * **/
class SecretActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_class_sealed.setOnClickListener {
            ...
            //密封类确保条件分支覆盖率所有的枚举类型，因此不再需要else分支
        ...
        btn_class_data.setOnClickListener {
            ...
            //数据类自带equals方法，用于判断两个对象是否一样，用==也可以,toString可以省略
            var result = if (lotus2 == lotus) "相等" else "不等"
