...
import com.wuchen.mykotlin.util.appendString
import com.wuchen.mykotlin.util.factorial
import com.wuchen.mykotlin.util.findFixPoint
import com.wuchen.mykotlin.util.maxCustom
import kotlinx.android.synthetic.main.activity_special.*

/**
 * Time：2019/5/14 14:07
 * Author：WuChen
 * Description：
 * **/
class SpecialActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_vararg_generic.setOnClickListener {
            tv_function_result.text =
                    when (count++ % 3) {
                        0 -> appendString<String>("古代四大发明", "造纸术", "火药", "指南针", "印刷术")
        ...
        var float_array: Array<Float> = arrayOf(1.0f, 2.0f, 3.0f, 4.0f, 5.0f)
        var double_array: Array<Double> = arrayOf(11.11, 22.22, 33.33, 44.44, 55.55)
